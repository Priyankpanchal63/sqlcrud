...
class DbHelper{
  ...
  _onCreate(Database db,int version)async{
    await db.execute("create table notes(id integer primary key autoincrement,title text not null,age integer not null,description text not null,email text not null)");
  }
